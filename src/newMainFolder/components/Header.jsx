        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            <motion.button
              ...
              className="flex items-center space-x-2 px-4 py-2 text-blue-900 hover:text-teal-700 font-medium"
            >
            ...
            <motion.button
              ...
              className="flex items-center space-x-2 px-6 py-2 bg-gradient-to-r from-blue-900 to-indigo-600 text-white rounded-full font-medium shadow-lg"
            >
