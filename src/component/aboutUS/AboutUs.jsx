        ...
        <div className="flex flex-col md:flex-row justify-between gap-8 items-center">
          ...
          <div className="space-y-4 md:w-[55%]">
            <h1 className="text-[45px] font-[600] text-gray-800 tracking-tight">
              About <b className="font-[600] text-blue-900">Us</b>
            </h1>

            <h2 className="text-2xl font-semibold text-gray-700">
              Transforming Smiles through <span className="text-blue-900">Compassion &amp; Technology</span>
            </h2>
        ...
        <div className="mt-20 mb-12 px-[20px]">
          <div className="text-center mb-8">
            <h2 className="text-[40px] font-[600] text-gray-800">
              Our Core <b className="font-[600] text-blue-900">Values</b>
            </h2>
          </div>
