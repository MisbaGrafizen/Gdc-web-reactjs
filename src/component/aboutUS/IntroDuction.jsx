...
import doctor from "../../../public/gdc/MainDoctors/dr-anand.webp";
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
        ...
        <div className="flex flex-col md:order-2">
          ...
          <div className="pt-5 text-center">
            <h3 className="text-2xl font-bold text-[#062f95]">Dr. Anand Jasani</h3>
            <p className="CDH-gradiant font-medium text-sm">
              Implantologist & Periodontist
            </p>
        ...
        <div className="lg:w-7/12 w-[90%] mx-auto md:mx-0 flex flex-col order-1">
          ...
          <h2 className="text-[27px] md:text-3xl font-[700] text-[#062f95] leading-[33px] md:leading-[40px] mb-3">
            ...
            <span className="CDH-gradiant text-black">
              — Consultant Dental Surgeon, Implantologist & Periodontist
            </span>
          </h2>

          <p className="text-[15px] text-gray-700 text-justify mb-6">
            Dr. Anand Jasani is a highly experienced dental surgeon specializing in implantology and periodontics. With over two decades of expertise in oral surgery, implant techniques, and advanced dental care, he is known for his commitment to excellence and patient care.
          </p>
          ...
          <div className="bg-gradient-to-br from-[#1b2644] to-blue-600 rounded-lg border shadow-md p-4 mb-8">
            ...
            <ul className="space-y-2 text-[#fff] text-[14px]">
              <li className="flex items-start">
                ...
                BDS, MDS (Implantologist and Periodontist)
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-4 h-4 text-white mr-2 mt-0.5" />
                Certified in oral surgery and implantology
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-4 h-4 text-white mr-2 mt-0.5" />
                23+ years of hands-on surgical experience
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-4 h-4 text-white mr-2 mt-0.5" />
                Specialized in advanced bone & soft tissue grafting
              </li>
              {/* <li className="flex items-start">
                <CheckCircle className="w-4 h-4 text-white mr-2 mt-0.5" />
                Speaker & attendee at global dental conferences
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-4 h-4 text-white mr-2 mt-0.5" />
                Former President of Indian Dental Association (Rajkot)
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-4 h-4 text-white mr-2 mt-0.5" />
                Trustee of Sardar Dham, Member of BNI Rajkot
              </li> */}
            </ul>
          </div>
        </div>
