...
import doctor from "../../../public/CoFounders/Haard Vasavada.png"
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
        ...
        <div className=" flex flex-col  md:order-2 ">
          ...
          <div className="pt-5 text-center">
            <h3 className="text-2xl font-bold text-[#062f95]">Dr. Haard Vasavada</h3>
            <p className="CDH-gradiant font-medium text-sm">
              MS, MCH (Neuro), WFNS Fellow
            </p>
...
{/* 
          ...
          <p className="text-[15px] text-gray-700 text-justify mb-6">
            Dr. Haard Vasavada specializes in advanced neurosurgical procedures, including brain tumor
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-[14px] text-[#fff]">
                  MS, MCH (Neurosurgery), WFNS Fellow
                </span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-4 h-4 text-[#fff] mr-2 mt-0.5" />
