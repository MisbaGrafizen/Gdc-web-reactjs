...
import doctor from "../../../public/gdc/MainDoctors/madam.webp"
import { MapPin, Clock, CheckCircle } from "lucide-react"

export default function DrRashmiJasaniIntro() {
  return (
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
        ...
        <div className="flex flex-col order-1">
          ...
          <div className="pt-5 text-center">
            <h3 className="text-2xl font-bold text-[#062f95]">Dr. Rashmi Jasani</h3>
            <p className="CDH-gradiant font-medium text-sm">
              Consultant Dental Surgeon & C. Orthodontist
            </p>
        ...
        <div className="lg:w-7/12 w-[90%] mx-auto md:mx-0 flex flex-col order-2">
          ...
          <p className="text-[15px] text-gray-700 text-justify mb-6">
            Dr. Rashmi Jasani is a distinguished Consultant Dental Surgeon and Orthodontist with years of experience in advanced dental care, including pediatric dentistry, orthodontics, and cosmetic treatments. She has a passion for excellence and a deep commitment to patient satisfaction and dental education.
          </p>
          ...
          <div className="bg-gradient-to-br from-[#1b2644] to-blue-600 rounded-lg border shadow-md p-4 mb-8">
            ...
            <ul className="space-y-2">
              {[
                ...
                "Master certificate in advance orthodontist CODO - Academy of dental excellence 2004",
                "Master certificate in pediatric dentistry from Dr. Meswakhi Khare at Mumbai in 2011",
                ...
                <li key={idx} className="flex items-start">
                  ...
                  <span className="text-[14px] text-white">{point}</span>
                </li>
              ))}
            </ul>
          </div>
